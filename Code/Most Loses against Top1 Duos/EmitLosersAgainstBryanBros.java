...
//En este vamos a obtener tuplas de la forma loser##winner##1
 ...
 * @author Aidan
 */
public class EmitLosersAgainstBryanBros {
	
	public static String bryanBros = "bob-bryan_mike-bryan";
	...
	public static class EmitWinnersMapper extends Mapper<Object, Text, Text, Text>{
		...
		public void map(Object keyIn, Text valueIn,
			...
			if (split[6].equals("t") & split[3].equals(bryanBros)) { //Entramos aca si el partido es uno que ganaron los hermanos bryan
				output.write(new Text(split[4]), new Text(split[3])); //invertimos el output
			}
		}
	}
	
	//Haciendolo de esta forma, entonces tendremos las tuplas de la forma (perdedor,[lista de BryanBros])
	...
	public static class EmitWinnersReducer extends 
		...
		public void reduce(Text key, Iterable<Text> values,
			...
			for(int i=0; i<list.size(); i++) {
				...
				//Tuplas de la forma (perdedor,1) y habra una por cada bryan bros
			}
	...
	public static void main(String[] args) throws Exception {
		...
		if (otherArgs.length != 2) {
			System.err.println("Usage: "+EmitLosersAgainstBryanBros.class.getName()+" <in> <out>");
			System.exit(2);
		}
		...
		job.setJarByClass(EmitLosersAgainstBryanBros.class);
