...
public class CountWinners {
	 ...
	 *
	 */
	public static class CountWinnersMapper extends Mapper<Object, Text, Text, IntWritable>{
		...
		public void map(Object key, Text value, Context output)
			...
			output.write(new Text(split[0]), one);
	 ...
	 *
	 */
	public static class CountWinnersReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
	...
	public static void main(String[] args) throws Exception {
		...
		if (otherArgs.length != 2) {
			System.err.println("Usage: "+CountWinners.class.getName()+" <in> <out>");
			System.exit(2);
		}
	    ...
	    job.setMapperClass(CountWinnersMapper.class);
	    job.setCombinerClass(CountWinnersReducer.class); // in this case a combiner is possible!
	    job.setReducerClass(CountWinnersReducer.class);
	     
	    job.setJarByClass(CountWinners.class);
