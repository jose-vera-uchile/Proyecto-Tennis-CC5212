...
public class EmitWinners {
	...
	public static class EmitWinnersMapper extends Mapper<Object, Text, Text, Text>{
		...
		public void map(Object keyIn, Text valueIn,
			...
			if (split[6].equals("t")) { //Vamos a devolver la llave como el ganador, y el map value como el perdedor
				output.write(new Text(split[3]), new Text(split[4]));
			}
		}
	}
	
	//Haciendolo de esta forma, entonces tendremos las tuplas de la forma (ganador,[lista de perdedores])
	...
	public static class EmitWinnersReducer extends 
		...
		public void reduce(Text key, Iterable<Text> values,
			...
			for(int i=0; i<list.size(); i++) {
				...
				//Tuplas de la forma (ganador##perdedor,1)
			}
	...
	public static void main(String[] args) throws Exception {
		...
		if (otherArgs.length != 2) {
			System.err.println("Usage: "+EmitWinners.class.getName()+" <in> <out>");
			System.exit(2);
		}
		...
		job.setJarByClass(EmitWinners.class);
